 ...
 */
final class Version20210801124246 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE reservation (id INT AUTO_INCREMENT NOT NULL, chambre_id INT DEFAULT NULL, numero_reservation INT NOT NULL, date_reservation DATETIME NOT NULL, date_fin_reservation DATE NOT NULL, nombre_de_personne INT NOT NULL, INDEX IDX_42C849559B177F54 (chambre_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
